...
<body>
    <div class="container">
        ...
        <p>Selamat Datang di Aplikasi Azzakiyyah</p>
        ...
        <div class="button-group">
            <div class="button">
                <a href="../analisa-wakif.php">Analisis Jumlah Wakif</a>
            </div>
            <div class="button">
                <a href="../analisa-riwayat.php">Analisis Semua Program</a>
            </div>
        </div>
